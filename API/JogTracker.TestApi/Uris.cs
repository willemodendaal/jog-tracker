...
namespace JogTracker.TestApi
{
    internal class Uris
    {
        public static readonly string Host = "https://dev.jogTracker.api/"; //Local IIS, to make testing easier.
        ...
        public static readonly string GetAllJogs = Base + "jog/all"; //Admin only function
